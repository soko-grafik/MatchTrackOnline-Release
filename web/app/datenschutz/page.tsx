      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        <div className="bg-zinc-900/60 border border-zinc-800 rounded-3xl p-6 sm:p-10 shadow-2xl backdrop-blur-sm">
          <div className="flex items-center gap-3 mb-6 pb-4 border-b border-zinc-800/80 text-emerald-400">
            ...
            <div>
              <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">DSGVO & TDDDG Transparenz</span>
              <h1 className="text-xl sm:text-2xl font-black text-white">Datenschutzerklärung</h1>
            </div>
          </div>
          ...
          {loading ? (
            <div className="py-16 text-center space-y-3">
              ...
              <p className="text-xs text-zinc-400">Lade Datenschutzerklärung...</p>
            </div>
          ) : (
            <MarkdownRenderer content={privacyContent} className="space-y-4" />
          )}
